...
# Paths
# ========================================
INPUT_PATH = "/path/to/allcells_scanvi_annotated.h5ad"  # Pre-processed dataset (REQUIRED)
OUTPUT_BASE_DIR = Path("/path/to/output/batch_subcluster_analysis_v4_1")
OUTPUT_BASE_DIR.mkdir(parents=True, exist_ok=True)

# ========================================
# Column Names
# ========================================
CELLTYPE_COLUMN = 'celltype_major'        # Column containing cell type annotations
