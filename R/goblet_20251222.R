...
after_genes
seurat_obj <- readRDS(
  '/home/h2048/data/R/1221/per_celltype_harmony_rogue/seurat_objects/Goblet_harmony.rds'
)
output_dir <- '/home/h2048/data/R/1223/goblet'
...
pdf(
  "Marker_Epithelial_Goblet_1.pdf",
  width = 12,
  height = 60,
