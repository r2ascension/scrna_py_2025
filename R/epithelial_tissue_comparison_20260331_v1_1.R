#!/usr/bin/env Rscript
# ==============================================================================
# Epithelial Tissue Comparison Pipeline v1.1.1 - PRODUCTION
# ==============================================================================
#
# Purpose:
...
OUTPUT_DIR <- "/home/h2048/data/R/0330/epithelial_tissue_comparison_v1_1"
...
cat("Epithelial Tissue Comparison Pipeline v1.1.1 (PRODUCTION)\n")
...
add("**Pipeline:** Epithelial Tissue Comparison v1.1.1 (pseudobulk DESeq2, ssGSEA, CHOIR, multi-database enrichment)")
add("")
...
add(""); add("---"); add("*Generated by epithelial_tissue_comparison_v1_1_1.R*")
...
cat("\n", paste(rep("=", 70), collapse = ""), "\n")
cat("EPITHELIAL TISSUE COMPARISON COMPLETE (v1.1.1)\n")
cat(paste(rep("=", 70), collapse = ""), "\n\n")
