...
# ===== Configuration =====
H5AD_FILE <- "/home/h2048/data/R/1228/B/b_filtered_20251228_2.rds"

OUTPUT_DIR <- "/home/h2048/data/R/1228/B/h5ad_single_mast_go_kegg_optimized"
...
cat("\n[1/9] Reading h5ad...\n")
t1 <- Sys.time()
# ===== Flexible Data Loading Based on File Extension =====
