...
# h5ad_file1 <- "/home/h2048/data/py/1217/cnmf_batch_production_v1_1_1/B_cells/batch_aware/cnmf_analysis_k40_1/B_cells_with_cnmf_k40.h5ad"
...
#     ggtitle(paste0("UMAP (Harmony) - ", 'RNA_bbknn_res.1'))
# )
# print(
...
# seurat_obj <- subset(
#   seurat_obj,
#   subset = RNA_bbknn_res.1 %in% c('10'),
#   invert = TRUE
# )
...
Idents(seurat_obj) <- "RNA_bbknn_res.1"
# saveRDS(seurat_obj, "b_filtered_20260103.rds")
