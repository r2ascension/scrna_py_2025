...
# ===== Configuration =====
H5AD_FILE <- "/home/h2048/data/R/1223/cnmf_batch_production_v1_2_2/Basal/batch_aware/cnmf_analysis_k40/Basal_with_cnmf_k40.h5ad"

OUTPUT_DIR <- "/home/h2048/data/R/1223/cnmf_batch_production_v1_2_2/Basal/h5ad_single_mast_go_kegg"
...
CLUSTER_COL <- "RNA_snn_res.1.5" # <<< 改成你h5ad里实际的cluster列名
