#!/usr/bin/env Rscript
# ==============================================================================
# Stromal SMC / Pericyte Tissue Comparison Pipeline v1.1.0
# ==============================================================================
#
# Generic-interface entrypoint:
#   - uses tissue_comparison_generic_wrapper_20260414.R
#   - keeps the stromal SMC/pericyte branch thin and declarative
#   - forces a fresh full rerun with wrapper-managed LLM requirement
#
# Smoke test:
#   PIPELINE_TEST_MODE=true Rscript stromal_smc_tissue_comparison_v1_1_0_20260414.R
#
# Date: 2026-04-14
# ==============================================================================
