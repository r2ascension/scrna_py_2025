...
metadata_path <- "/home/h2048/data/source/1213/np_alexandria_meta_with_sss.csv"
count_matrix_path <- "/home/h2048/data/source/1213/SuppTable6_ScrapeALL_merged.txt" # UPDATE THIS
output_rds_path <- "/home/h2048/data/R/1214/Jose_Ordovas_Montanes_2018_1.rds"

sample_column <- "sample"
celltype_column <- "cell_type__ontology_label"
barcode_column <- "NAME"
...
seurat_obj <- subset(seurat_obj, subset = disease_level_1 != 'healthy')
...
seurat_obj$dataset <- 'Jose_Ordovas_Montanes_2018'
...
seurat_obj <- readRDS('/home/h2048/data/R/1214/Jose_Ordovas_Montanes_2018.rds')
seurat_obj <- subset(seurat_obj, subset = disease_level_1 != 'healthy')
saveRDS(seurat_obj, '/home/h2048/data/R/1214/Jose_Ordovas_Montanes_2018.rds')
