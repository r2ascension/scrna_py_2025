...
# ===== Paths =====
BASE_DIR = Path(f"/home/h2048/data/py/{datetime.now().strftime('%m%d')}/myeloid_analysis") 
INPUT_FILE = Path('/home/h2048/data/py/0111/celltypist_myeloid/adata_myeloid_FINAL.h5ad')
