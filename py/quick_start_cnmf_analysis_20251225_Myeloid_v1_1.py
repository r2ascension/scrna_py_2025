...
# 原始数据路径（包含细胞类型注释）
ORIGINAL_H5AD = Path('/home/h2048/data/py/1217/myeloid/bbknn/adata_bbknn_filtered.h5ad')
...
CLUSTER_COL = 'leiden_Myeloid_res0.8'  # cluster列名，会自动检测
