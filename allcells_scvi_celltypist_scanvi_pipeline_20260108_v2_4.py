...
LOAD_SCANVI_EXISTING_IF_EXISTS = True
...
SCANVI_LEARNING_RATE = 5e-4  # 从 1e-3 改为 5e-4
SCANVI_GRADIENT_CLIP = 1.0   # 新增
SCANVI_BATCH_SIZE = 256      # 新增
...
if not scvi_model_exists or not LOAD_SCVI_IF_EXISTS:
    ...
    train_kwargs = {
        ...
        'batch_size': SCANVI_BATCH_SIZE,  # 新增
        'early_stopping': True,
