...
# -*- coding: utf-8 -*-
"""
Label-Guided cNMF Pipeline v1.3-HOTFIX2 - Production Integrated
================================================================
Fixes:
...
OUTPUT_DIR = Path(f"/home/h2048/data/py/{datetime.now().strftime('%m%d')}/cnmf_v1.3_fixed_optimized_k")
...
# Gene filtering: keep ribo/histone by default
GENE_FILTER_CONFIG = {
    "remove_mt": True,
    "remove_ribo": False,
    "remove_histone": False,
    "remove_pseudogenes": True,     # conservative: remove ribo pseudo only (safe)
    "remove_ensg": True,
    "remove_unannotated": True,
}

# cNMF - Optimized for lineage-level analysis
CNMF_CONFIG = {
    "k_range_auto": True,
    "k_rules": {
...
def main():
    ...
    print("=" * 90)
    print("Label-Guided cNMF Pipeline v1.3-HOTFIX2 (Production Integrated)")
    print("=" * 90)
    ...
    for i, group in enumerate(groups, 1):
        ...
        # gene filtering (does NOT modify raw)
