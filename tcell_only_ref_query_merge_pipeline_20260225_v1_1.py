...
SCVI_N_HIDDEN = 128
SCVI_DROPOUT = 0.1
MAX_EPOCHS_SCVI = _env_int("TCELL_MAX_EPOCHS_SCVI", 400)

MAX_EPOCHS_SCANVI = _env_int("TCELL_MAX_EPOCHS_SCANVI", 200)
UNLABELED_CATEGORY = "Unknown"

BATCH_SIZE = _env_int("TCELL_BATCH_SIZE", 256)
LEARNING_RATE = 1e-3
WEIGHT_DECAY = 0.0

FORCE_RETRAIN = _env_bool("TCELL_FORCE_RETRAIN", False)
FORCE_REEXPORT = _env_bool("TCELL_FORCE_REEXPORT", False)
ENABLE_TRAIN_CHECKPOINTS = _env_bool("TCELL_ENABLE_TRAIN_CHECKPOINTS", True)
