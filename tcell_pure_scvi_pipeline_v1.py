...
# Input/Output
INPUT_H5AD = "/home/h2048/data/py/1204/TNK_annotated/adata_Tcell_pure.h5ad"  # Changed: Pure T cells only
OUTPUT_DIR = "/home/h2048/data/py/1204/Tcell_pure_scvi"  # Changed: New output directory
...
SCVI_N_LATENT = 75       # Latent dimensions
SCVI_N_LAYERS = 3        # Neural network depth
...
# UMAP parameters
UMAP_MIN_DIST = 0.3    # Smaller = tighter clusters
UMAP_SPREAD = 1.8       # Larger = more dispersed
UMAP_N_NEIGHBORS = 50
...
# Store for summary - CRITICAL FIX: convert to scalar
n_training_epochs = len(train_elbo)
final_elbo_raw = train_elbo[-1]
# Handle both numpy arrays and regular numbers
if hasattr(final_elbo_raw, 'item'):
    final_elbo = float(final_elbo_raw.item())  # numpy array → scalar
else:
    final_elbo = float(final_elbo_raw)  # already scalar
