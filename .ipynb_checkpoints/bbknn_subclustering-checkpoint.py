...
# ========== 输入输出配置 ==========
input_h5ad_path = "/home/h2048/data/py/1029/bbknn_annotation_analysis/adata_bbknn_annotated_corrected.h5ad"
...
# ========== 细胞类型筛选配置 ==========
target_cell_types = ['Fibroblast','SMC','B']  # 例如: ["Epithelial", "T", "Myeloid"]
