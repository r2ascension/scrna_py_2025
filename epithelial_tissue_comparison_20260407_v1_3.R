#!/usr/bin/env Rscript
# ==============================================================================
# Epithelial Tissue Comparison Pipeline v1.3.0 - PRODUCTION
# ==============================================================================
#
# Purpose:
...
SCRIPT_BASENAME  <- "epithelial_tissue_comparison_20260407_v1_3.R"
OUTPUT_TAG       <- "epithelial_tissue_comparison_v1_3"
...
cat(sprintf("%s Changes (vs v1.2.0):\n", PIPELINE_VERSION))
