...
# ===== Paths =====
BASE_DIR = Path(f"/home/h2048/data/py/{datetime.now().strftime('%m%d')}/stromal_analysis") 
INPUT_FILE = Path('/home/h2048/data/py/0114/stromal_pure_scanvi/adata_stromal_PURE_FINAL.h5ad')
...
CELLTYPE_KEY = 'cell_type_scanvi_filt'  # scANVI annotations
SCANVI_LATENT_KEY = 'X_scanvi'  # For global UMAP
