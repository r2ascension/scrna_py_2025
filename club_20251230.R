...
library(SCNT)
library(data.table)
output_dir <- '/home/h2048/data/R/1230/club'
...
h5ad_file1 <- "/home/h2048/data/R/1223/cnmf_batch_production_v1_2_2/Club/batch_aware/cnmf_analysis_k35/Club_with_cnmf_k35.h5ad"
...
Idents(seurat_obj) <- "RNA_snn_res.1" # 如果你的列名不同，在这里改
...
# seurat_obj <- subset(
#   seurat_obj,
#   subset = RNA_snn_res.1 %in% c('20', '23'),
#   invert = TRUE
# )
