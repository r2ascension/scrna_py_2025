#!/usr/bin/env python3
"""
Myeloid Subcluster Analysis Pipeline v2.1 (FIXED)
=================================================
Author: r2end
Date: 2025-01-21
...
Purpose:
- Subcluster analysis of myeloid cells
- BBKNN integration across batches
- Automated marker gene identification with proper statistical correction

Input: myeloid_annotated.h5ad
Output: myeloid_subcluster_analyzed.h5ad
...
# ===== 2. Configuration =====
# Paths
INPUT_PATH = "/path/to/myeloid_annotated.h5ad"
...
print("=" * 80)
print("MYELOID SUBCLUSTER ANALYSIS PIPELINE v2.1 (FIXED)")
print("=" * 80)
...
sc.pl.umap(
    ...
    legend_loc='on data',
    legend_fontsize=8,
    title='Myeloid Subclusters (BBKNN + Leiden)',
    ax=ax,
    show=False
)
plt.tight_layout()
...
# Save annotated data
output_path = OUTPUT_DIR / 'myeloid_subcluster_analyzed.h5ad'
